...
<body class="bg-gray-100 font-sans">
    ...
    <div class="movie-header bg-white shadow rounded-lg p-6 m-6 flex">
        <img src="Images/joker.jpg" alt="Joker Movie Poster" class="w-64 h-auto rounded-md shadow-md">
